...
a message can also be auto-populated with data that persists between requests, with the use of ``global data`` (read [here](https://github.com/talmeym/regurgitator-extensions-web#global-data-servlet)) and ``regurgitator sessions`` (read [here](https://github.com/talmeym/regurgitator-core-xml#identify-session)).
